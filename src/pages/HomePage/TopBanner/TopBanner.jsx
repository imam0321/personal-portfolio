  ...
  return (
    <section id="home" className="mb-32">
      ...
      <h1 className="lg:text-[65px] lg:leading-[75px] md:text-[50px] md:leading-[60px] text-[28px] leading-[40px]">
        Hey! I'm <span className="text-primary">Imam</span>,<br /> Software
        Engineer
      </h1>
      <p className="mt-6 lg:text-2xl md:text-2xl text-md">
        A forward-thinking software engineer. who can work as a web developer in
      ...
      <div className="flex lg:flex-row md:flex-row flex-col justify-between lg:items-end md:items-end items-center">
        ...
        <a
          href="#projects"
          className="flex hover:text-primary items-center gap-2 text-2xl icon cursor-pointer lg:mt-0 md:mt-0 mt-14"
        >
          My Projects
          <lord-icon
            target="div"
